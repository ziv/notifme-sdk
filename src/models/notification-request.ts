interface RequestMetadataType {
  id?: string;
  userId?: string;
}

export interface EmailRequestType extends RequestMetadataType {
  from: string;
  to: string;
  subject: string;
  cc?: string[];
...
export interface PushRequestType extends RequestMetadataType {
  ...
  customize?: (key: string, type: PushRequestType) => Promise<PushRequestType>
}

export interface SmsRequestType extends RequestMetadataType {
  from: string;
  to: string;
  text: string;
...
// )
  customize?: (key: string, type: SmsRequestType) => Promise<SmsRequestType>
}

export interface VoiceRequestType extends RequestMetadataType {
  from: string;
  to: string;
  url: string;
  method?: string;
  ...
  timeout?: number;
  customize?: (key: string, type: VoiceRequestType) => Promise<VoiceRequestType>
}

export interface WebpushRequestType extends RequestMetadataType {
  subscription: {
    endpoint: string;
    keys: {
      auth: string;
  ...
  customize?: (key: string, type: WebpushRequestType) => Promise<WebpushRequestType>
}

export interface SlackRequestType extends RequestMetadataType {
